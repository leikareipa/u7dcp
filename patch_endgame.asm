...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; Opens the ENDGAME.EXE file for reading/writing, and verifies that its size is as expected.
;;;
;;; EXPECTS:
;;;     (- unspecified)
;;; DESTROYS:
...
Open_Endgame_exe:
    ...
    mov [err_additional],err_no_file_endgame
    jmp .exit_fail
    .l2:
    mov [fh_endgame_exe],ax                 ; store the file handle for later use.

    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ; verify that the file size of ENDGAME.EXE is as expected.
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ; seek to the end of the file.
    mov bx,[fh_endgame_exe]
    mov dx,0
    mov cx,0
    mov ax,4202h
    int 21h
    ...
    shl ebx,16
    mov bx,ax
    cmp ebx,ENDGAME_EXE_BYTESIZE
    je .rewind_file
    mov [err_additional],err_file_size_endgame
    jmp .exit_fail
    .rewind_file:
    mov bx,[fh_endgame_exe]
    mov dx,0
...
Patch_Endgame_exe:
    ...
    .p1_1:
        ...
        mov [file_buffer+di+bx],al          ; apply it to the data block.
        add bx,1
        cmp bx,patch_1_len
        jb .p1_1
    mov di,37
